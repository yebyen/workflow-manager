...
docker tag hephyci/workflow-manager:canary quay.io/hephyci/workflow-manager:canary
docker tag hephyci/workflow-manager:${version} quay.io/hephyci/workflow-manager:${version}
